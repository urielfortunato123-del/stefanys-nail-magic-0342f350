  ...
  return (
    <div className="space-y-8">
      ...
      <section className="glass-card relative overflow-hidden rounded-3xl p-6 pt-8 text-center">
        ...
        <img src={logo} alt="Stefany Próspero" width={208} height={208} className="mx-auto mb-4 h-52 w-52 rounded-full object-cover ring-1 ring-white/10 sm:h-60 sm:w-60" />
